...
div[data-testid="stTextInput"] input{
    ...
    padding:14px 16px!important;font-size:0.95rem!important;height:52px!important;
}
div[data-testid="stTextInput"] input:focus{
    border-color:#7C3AED!important;box-shadow:0 0 0 3px rgba(124,58,237,0.15)!important;
}

/* ── URL CARD (st.container border) ── */
...
div[data-testid="stHorizontalBlock"]:first-of-type{
    ...
    padding:12px 40px!important;margin:0!important;position:sticky!important;
...
with nb_c:
    st.markdown("""<div class="percepta-brand-wrap">
        <div class="percepta-icon"><svg width="16" height="16" viewBox="0 0 22 22" fill="none">
...
if nav=="Overview":
    ...
    st.markdown("""
<div style="background:linear-gradient(170deg,#ffffff 55%,#F3EEFF 100%);padding:52px 40px 40px;text-align:center;">
  ...
  <p style="font-size:1.05rem;color:#6B7280;max-width:860px;margin:0 auto 36px;line-height:1.7;">The Percepta GEO Score is a single 0–100 number that measures how often and how favorably your brand is cited in AI-generated responses — across ChatGPT, Gemini, and other major AI engines.</p>
...
<div style="background:white;padding:80px 40px;border-top:1px solid #E5E7EB;">
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center;margin-bottom:56px;">
    <div>
      ...
      <p style="font-size:0.95rem;color:#6B7280;line-height:1.8;margin:0;">Your GEO Score distills complex AI citation data into a single, actionable metric.</p>
    </div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:16px;">
    <div style="background:#ECFDF5;border-radius:14px;padding:20px;text-align:center;border:1.5px solid #6EE7B7;"><div style="font-size:0.82rem;font-weight:700;color:#065F46;margin-bottom:4px;">80–100</div><div style="font-size:1.3rem;font-weight:900;color:#065F46;margin-bottom:4px;">Excellent</div><div style="font-size:0.78rem;color:#065F46;">Well optimized for AI citation</div></div>
    <div style="background:#EFF6FF;border-radius:14px;padding:20px;text-align:center;border:1.5px solid #93C5FD;"><div style="font-size:0.82rem;font-weight:700;color:#1E40AF;margin-bottom:4px;">70–79</div><div style="font-size:1.3rem;font-weight:900;color:#1E40AF;margin-bottom:4px;">Good</div><div style="font-size:0.78rem;color:#1E40AF;">Minor improvements recommended</div></div>
    <div style="background:#FFFBEB;border-radius:14px;padding:20px;text-align:center;border:1.5px solid #FCD34D;"><div style="font-size:0.82rem;font-weight:700;color:#92400E;margin-bottom:4px;">45–69</div><div style="font-size:1.3rem;font-weight:900;color:#92400E;margin-bottom:4px;">Needs Work</div><div style="font-size:0.78rem;color:#92400E;">Several issues to address</div></div>
    <div style="background:#FFF1F2;border-radius:14px;padding:20px;text-align:center;border:1.5px solid #FCA5A5;"><div style="font-size:0.82rem;font-weight:700;color:#991B1B;margin-bottom:4px;">0–44</div><div style="font-size:1.3rem;font-weight:900;color:#991B1B;margin-bottom:4px;">Poor</div><div style="font-size:0.78rem;color:#991B1B;">Major optimization needed</div></div>
  </div>
</div>
<div style="background:#F9F9FC;padding:80px 40px;border-top:1px solid #E5E7EB;">
  <div style="text-align:center;margin-bottom:52px;"><div class="section-tag">What You Gain</div><h2 style="font-size:2.2rem;font-weight:900;color:#111827;margin:10px 0 14px;line-height:1.2;">Others Give You Data.<br>We Give You a Solution.</h2></div>
...
# ════════════════════════════════════════════════════════════
    ...
    st.markdown("""
    <div style="background:linear-gradient(135deg,#5B21B6 0%,#7C3AED 50%,#9333EA 100%);padding:64px 40px 56px;text-align:center;">
        <div style="display:inline-flex;align-items:center;gap:8px;border:1.5px solid rgba(255,255,255,0.5);border-radius:50px;padding:8px 24px;font-size:0.78rem;font-weight:700;color:white;margin-bottom:28px;background:rgba(255,255,255,0.15);">
            ✦ &nbsp;Real GEO Scoring
        </div>
    ...
    if not has_result:
        ...
        # Score band cards
        st.markdown("""
        <div style="background:#F3F4F6;padding:32px 40px 24px 40px;">
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:16px;">
            <div style="background:#ECFDF5;border-radius:14px;padding:16px 20px;text-align:center;border:1.5px solid #6EE7B7;">
              <div style="font-size:0.8rem;font-weight:700;color:#065F46;margin-bottom:3px;">80–100</div>
              <div style="font-size:1.35rem;font-weight:900;color:#065F46;margin-bottom:3px;">Excellent</div>
              <div style="font-size:0.75rem;color:#065F46;">Well optimized for AI citation</div>
            </div>
            <div style="background:#EFF6FF;border-radius:14px;padding:16px 20px;text-align:center;border:1.5px solid #93C5FD;">
              <div style="font-size:0.8rem;font-weight:700;color:#1E40AF;margin-bottom:3px;">70–79</div>
              <div style="font-size:1.35rem;font-weight:900;color:#1E40AF;margin-bottom:3px;">Good</div>
              <div style="font-size:0.75rem;color:#1E40AF;">Minor improvements recommended</div>
            </div>
            <div style="background:#FFFBEB;border-radius:14px;padding:16px 20px;text-align:center;border:1.5px solid #FCD34D;">
              <div style="font-size:0.8rem;font-weight:700;color:#92400E;margin-bottom:3px;">45–69</div>
              <div style="font-size:1.35rem;font-weight:900;color:#92400E;margin-bottom:3px;">Needs Work</div>
              <div style="font-size:0.75rem;color:#92400E;">Several issues to address</div>
            </div>
            <div style="background:#FFF1F2;border-radius:14px;padding:16px 20px;text-align:center;border:1.5px solid #FCA5A5;">
              <div style="font-size:0.8rem;font-weight:700;color:#991B1B;margin-bottom:3px;">0–44</div>
              <div style="font-size:1.35rem;font-weight:900;color:#991B1B;margin-bottom:3px;">Poor</div>
              <div style="font-size:0.75rem;color:#991B1B;">Major optimization needed</div>
            </div>
          </div>
        </div>
...
# ════════════════════════════════════════════════════════════
    ...
    st.markdown("""<div style="background:white;padding:56px 40px 0 40px;text-align:center;margin-bottom:0;">
        ...
        <p style="font-size:0.92rem;color:#6B7280;margin:0 auto 40px;max-width:680px;line-height:1.7;">While search spend continues to rise, its impact is fading as AI agents increasingly shape the decisions search used to influence.</p>
    </div>""", unsafe_allow_html=True)

    col_l, col_mid, col_r = st.columns([1, 1.1, 1])
    with col_l:
        st.markdown("""<div style="padding:0 20px 0 40px;display:flex;flex-direction:column;gap:36px;">
            <div><div style="font-size:0.95rem;font-weight:800;color:#111827;margin-bottom:3px;"><strong>Workstream 1:</strong></div><div style="font-size:0.88rem;font-style:italic;color:#374151;margin-bottom:10px;">Agent Ranking Diagnostic (ARD)</div><p style="font-size:0.82rem;color:#6B7280;line-height:1.7;margin:0;">Conduct the initial evaluation to <strong>establish the baseline ranking performance</strong> of AI agents when comparing your brand to competitive offerings.</p></div>
            <div><div style="font-size:0.95rem;font-weight:800;color:#111827;margin-bottom:3px;"><strong>Workstream 4:</strong></div><div style="font-size:0.88rem;font-style:italic;color:#374151;margin-bottom:10px;">Impact Measurement (Re-Diagnostic)</div><p style="font-size:0.82rem;color:#6B7280;line-height:1.7;margin:0;">Following the optimization activities, the Agent Ranking Diagnostic will be performed again to <strong>Re-measure performance</strong>.</p></div>
        </div>""", unsafe_allow_html=True)
    with col_mid:
        st.image("infinity.png", use_container_width=True)
    with col_r:
        st.markdown("""<div style="padding:0 40px 0 20px;display:flex;flex-direction:column;gap:36px;">
            <div><div style="font-size:0.95rem;font-weight:800;color:#111827;margin-bottom:3px;"><strong>Workstream 3:</strong></div><div style="font-size:0.88rem;font-style:italic;color:#374151;margin-bottom:10px;">Distribution and Technical Influence Layer (DTI)</div><p style="font-size:0.82rem;color:#6B7280;line-height:1.7;margin:0;">Pinpoint and <strong>propose specific technical and distribution improvements</strong> to maximize LLM ingestion of your verified content.</p></div>
            <div><div style="font-size:0.95rem;font-weight:800;color:#111827;margin-bottom:3px;"><strong>Workstream 2:</strong></div><div style="font-size:0.88rem;font-style:italic;color:#374151;margin-bottom:10px;">Agent Optimization Plan (AOP)</div><p style="font-size:0.82rem;color:#6B7280;line-height:1.7;margin:0;">Based on the diagnostic findings, <strong>design and deploy a specific optimization strategy</strong> aimed at elevating agent recognition of your brand.</p></div>
        </div>""", unsafe_allow_html=True)
    ...
    <div style="background:#F9F9FC;padding:48px 40px;border-bottom:1px solid #E5E7EB;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:12px;margin-bottom:12px;">
            ...
            <div style="background:white;border:1px solid #E5E7EB;border-radius:8px;padding:18px;"><div style="font-size:0.82rem;font-weight:700;color:#111827;border-bottom:1px solid #F3F4F6;padding-bottom:8px;margin-bottom:12px;text-align:center;">Activities</div><ul style="list-style:disc;padding-left:16px;margin:0;font-size:0.78rem;color:#374151;line-height:1.75;"><li>Develop LLM-ready content assets</li><li>Strengthen product-attribute associations</li><li>Optimize content for agent ingestion</li><li>Create Content Influence Blueprint</li></ul></div>
            <div style="background:white;border:1px solid #E5E7EB;border-radius:8px;padding:18px;"><div style="font-size:0.82rem;font-weight:700;color:#111827;border-bottom:1px solid #F3F4F6;padding-bottom:8px;margin-bottom:12px;text-align:center;">Activities</div><ul style="list-style:disc;padding-left:16px;margin:0;font-size:0.78rem;color:#374151;line-height:1.75;"><li>Audit tagging and metadata</li><li>Identify missing structured data</li><li>Improve backlink structure</li><li>Identify dormant URLs</li><li>Audit schema markup</li></ul></div>
            <div style="background:white;border:1px solid #E5E7EB;border-radius:8px;padding:18px;"><div style="font-size:0.82rem;font-weight:700;color:#111827;border-bottom:1px solid #F3F4F6;padding-bottom:8px;margin-bottom:12px;text-align:center;">Activities</div><ul style="list-style:disc;padding-left:16px;margin:0;font-size:0.78rem;color:#374151;line-height:1.75;"><li>Re-test all prompts</li><li>Measure semantic drift and ranking changes</li><li>Recompute AXO Score</li></ul></div>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:12px;">
            ...
            <div style="background:#EEEAF8;border:1px solid #DDD6FE;border-radius:8px;padding:18px;"><div style="font-size:0.82rem;font-weight:700;color:#111827;border-bottom:1px solid #DDD6FE;padding-bottom:8px;margin-bottom:12px;text-align:center;">Deliverables</div><ul style="list-style:disc;padding-left:16px;margin:0;font-size:0.78rem;color:#374151;line-height:1.75;"><li>AXO Impact Report</li><li>Before/After Ranking Comparison</li><li>Updated AXO Score (v2.0)</li><li>Recommendations for ongoing improvement</li></ul></div>
        </div>
    </div>
    <div style="background:white;padding:48px 40px;border-bottom:1px solid #E5E7EB;">
        <div style="text-align:center;margin-bottom:36px;"><div class="section-tag">Explore Offers</div><h2 style="font-size:1.8rem;font-weight:800;color:#111827;margin:8px 0 6px;">Choose Your Pilot Program</h2><p style="font-size:0.88rem;color:#6B7280;max-width:420px;margin:0 auto;">Start with what fits your timeline. Scale as you see results.</p></div>
