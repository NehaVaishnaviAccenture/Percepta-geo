...
# ════════════════════════════════════════════════════════════
    ...
    st.markdown("""
    <div style="background:linear-gradient(135deg,#6D28D9 0%,#7C3AED 60%,#9333EA 100%);padding:64px 40px 56px 40px;text-align:center;">
        <div style="display:inline-flex;align-items:center;gap:8px;border:1.5px solid rgba(255,255,255,0.45);border-radius:50px;padding:8px 22px;font-size:0.78rem;font-weight:700;color:white;margin-bottom:28px;background:rgba(255,255,255,0.15);backdrop-filter:blur(4px);">
            ✦ &nbsp;Real GEO Scoring
        </div>
    ...
    if not has_result:
        st.markdown("""
        <div style="background:#F3F4F6;padding:32px 40px 0 40px;">
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:16px;margin-bottom:28px;">
            <div style="background:#ECFDF5;border-radius:14px;padding:20px 20px;text-align:center;border:1.5px solid #6EE7B7;">
              <div style="font-size:0.82rem;font-weight:700;color:#065F46;margin-bottom:4px;">80–100</div>
              <div style="font-size:1.4rem;font-weight:900;color:#065F46;margin-bottom:4px;">Excellent</div>
              <div style="font-size:0.78rem;color:#065F46;">Well optimized for AI citation</div>
            </div>
            <div style="background:#EFF6FF;border-radius:14px;padding:20px 20px;text-align:center;border:1.5px solid #93C5FD;">
              <div style="font-size:0.82rem;font-weight:700;color:#1E40AF;margin-bottom:4px;">70–79</div>
              <div style="font-size:1.4rem;font-weight:900;color:#1E40AF;margin-bottom:4px;">Good</div>
              <div style="font-size:0.78rem;color:#1E40AF;">Minor improvements recommended</div>
            </div>
            <div style="background:#FFFBEB;border-radius:14px;padding:20px 20px;text-align:center;border:1.5px solid #FCD34D;">
              <div style="font-size:0.82rem;font-weight:700;color:#92400E;margin-bottom:4px;">45–69</div>
              <div style="font-size:1.4rem;font-weight:900;color:#92400E;margin-bottom:4px;">Needs Work</div>
              <div style="font-size:0.78rem;color:#92400E;">Several issues to address</div>
            </div>
            <div style="background:#FFF1F2;border-radius:14px;padding:20px 20px;text-align:center;border:1.5px solid #FCA5A5;">
              <div style="font-size:0.82rem;font-weight:700;color:#991B1B;margin-bottom:4px;">0–44</div>
              <div style="font-size:1.4rem;font-weight:900;color:#991B1B;margin-bottom:4px;">Poor</div>
              <div style="font-size:0.78rem;color:#991B1B;">Major optimization needed</div>
            </div>
          </div>
        </div>
        """, unsafe_allow_html=True)
