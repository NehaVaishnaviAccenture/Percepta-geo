...
Also for each domain, provide top 3 specific page paths or topics on that domain that AI cites most.
...
def get_page_intelligence(internal_links, brand, responses):
    ...
    for lk in internal_links[:8]:
        path = lk.get("path",""); label = lk.get("label",""); url = lk.get("url","")
...
def analyze_geo_with_ai(page_data):
    ...
    if mentions==0:
        ...
        sc = {"citation_share":0,"sentiment":0,"prominence":0,"share_of_voice":0,"avg_rank":"N/A",
              "strengths":["Brand not yet appearing in AI responses for industry queries.","Baseline established — clear room to grow.","Competitor brands present, confirming category is AI-discoverable."],
              "improvements":["Brand not mentioned in any of the 20 generic industry queries.","AI models not associating this brand with key consumer questions.","No citation authority established.","Competitors appearing instead.","Content not structured for AI discovery."],
...
.percepta-icon{width:32px;height:32px;flex-shrink:0;border-radius:8px;background:#7C3AED;display:flex;align-items:center;justify-content:center;}
.percepta-title{font-size:1rem;font-weight:800;color:#111827;letter-spacing:-0.3px;line-height:1;}
...
if nav=="Overview":
    ...
    # HERO
    st.markdown("""
    <div style="background:#7C3AED;padding:100px 120px;color:white;">
        <div style="max-width:700px;">
            <div style="font-size:0.78rem;font-weight:600;letter-spacing:.12em;color:rgba(255,255,255,0.7);margin-bottom:20px;text-transform:uppercase;">Accenture's AI GEO Intelligence Platform</div>
            <h1 style="font-size:3.6rem;font-weight:900;color:white;line-height:1.1;margin:0 0 24px 0;letter-spacing:-1.5px;">Know Where Your Brand Lives in AI.</h1>
            <p style="font-size:1.1rem;color:rgba(255,255,255,0.85);line-height:1.8;margin-bottom:40px;max-width:560px;">The only platform that measures, scores, and improves your brand's visibility across AI search engines in real time.</p>
            <div style="display:flex;gap:12px;flex-wrap:wrap;">
                <div style="border:1px solid rgba(255,255,255,0.4);border-radius:50px;padding:8px 20px;font-size:0.84rem;font-weight:500;color:white;">Live GEO Scoring</div>
                <div style="border:1px solid rgba(255,255,255,0.4);border-radius:50px;padding:8px 20px;font-size:0.84rem;font-weight:500;color:white;">Competitor Benchmarking</div>
                <div style="border:1px solid rgba(255,255,255,0.4);border-radius:50px;padding:8px 20px;font-size:0.84rem;font-weight:500;color:white;">Actionable Recommendations</div>
            </div>
        </div>
    ...
    # STATS BAR
    st.markdown("""
    <div style="background:#F9F9FC;border-bottom:1px solid #E5E7EB;padding:28px 120px;">
        <div style="display:flex;gap:64px;align-items:center;flex-wrap:wrap;">
            <div><div style="font-size:1.8rem;font-weight:800;color:#111827;">10+</div><div style="font-size:0.8rem;color:#6B7280;margin-top:2px;">Client Engagements</div></div>
            <div style="width:1px;height:40px;background:#E5E7EB;"></div>
            <div><div style="font-size:1.8rem;font-weight:800;color:#111827;">Real-time</div><div style="font-size:0.8rem;color:#6B7280;margin-top:2px;">Live AI Queries</div></div>
            <div style="width:1px;height:40px;background:#E5E7EB;"></div>
            <div><div style="font-size:1.8rem;font-weight:800;color:#111827;">4X</div><div style="font-size:0.8rem;color:#6B7280;margin-top:2px;">Higher Conversion from AI</div></div>
            <div style="width:1px;height:40px;background:#E5E7EB;"></div>
            <div><div style="font-size:1.8rem;font-weight:800;color:#111827;">200</div><div style="font-size:0.8rem;color:#6B7280;margin-top:2px;">AI Queries Per Analysis</div></div>
            <div style="width:1px;height:40px;background:#E5E7EB;"></div>
            <div><div style="font-size:1.8rem;font-weight:800;color:#111827;">#1</div><div style="font-size:0.8rem;color:#6B7280;margin-top:2px;">GEO Score + Strategy</div></div>
        </div>
    </div>""",unsafe_allow_html=True)

    # HOW IT WORKS / WHAT IS GEO SCORE
    st.markdown("""
    <div style="background:white;padding:80px 120px;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:start;">
            <div>
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">How It Works</div>
                <h2 style="font-size:2rem;font-weight:800;color:#111827;margin:0 0 20px 0;line-height:1.25;">What is a GEO Score?</h2>
                <p style="font-size:0.95rem;color:#6B7280;line-height:1.8;margin-bottom:20px;">The GEO Score is a single 0 to 100 composite metric that measures how visible and favorably your brand appears across AI-generated responses. Like a credit score for your digital reputation in AI, it tells you exactly where you stand and what it takes to improve.</p>
                <p style="font-size:0.95rem;color:#6B7280;line-height:1.8;margin-bottom:32px;">Percepta runs 200 live queries across leading AI models and calculates your score from five weighted components. A higher score means more AI recommendations, more visibility, and more conversions.</p>
                <div style="display:flex;flex-direction:column;gap:14px;">
                    <div style="display:flex;align-items:center;gap:14px;padding:16px 20px;border:1px solid #E5E7EB;border-radius:10px;">
                        <div style="width:10px;height:10px;border-radius:50%;background:#7C3AED;flex-shrink:0;"></div>
                        <div><div style="font-size:0.88rem;font-weight:600;color:#111827;">It is objective</div><div style="font-size:0.82rem;color:#6B7280;margin-top:2px;">Based on live AI model responses, not estimates or historical data</div></div>
                    </div>
                    <div style="display:flex;align-items:center;gap:14px;padding:16px 20px;border:1px solid #E5E7EB;border-radius:10px;">
                        <div style="width:10px;height:10px;border-radius:50%;background:#7C3AED;flex-shrink:0;"></div>
                        <div><div style="font-size:0.88rem;font-weight:600;color:#111827;">It is real-time</div><div style="font-size:0.82rem;color:#6B7280;margin-top:2px;">Every analysis reflects what AI says about your brand right now</div></div>
                    </div>
                    <div style="display:flex;align-items:center;gap:14px;padding:16px 20px;border:1px solid #E5E7EB;border-radius:10px;">
                        <div style="width:10px;height:10px;border-radius:50%;background:#7C3AED;flex-shrink:0;"></div>
                        <div><div style="font-size:0.88rem;font-weight:600;color:#111827;">It is actionable</div><div style="font-size:0.82rem;color:#6B7280;margin-top:2px;">Every score comes with a priority action plan you can act on immediately</div></div>
                    </div>
                </div>
            </div>
            <div>
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">Score Breakdown</div>
                <h2 style="font-size:2rem;font-weight:800;color:#111827;margin:0 0 28px 0;line-height:1.25;">How the Score is Calculated</h2>
                <div style="display:flex;flex-direction:column;gap:0;">
                    <div style="padding:20px 0;border-bottom:1px solid #F3F4F6;">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                            <div style="font-size:0.95rem;font-weight:700;color:#111827;">Visibility</div>
                            <div style="background:#EDE9FE;color:#5B21B6;border-radius:99px;padding:3px 14px;font-size:0.82rem;font-weight:700;">30%</div>
                        </div>
                        <div style="background:#F3F4F6;border-radius:4px;height:6px;width:100%;"><div style="background:#7C3AED;height:6px;border-radius:4px;width:30%;"></div></div>
                        <div style="font-size:0.82rem;color:#6B7280;margin-top:6px;">Did your brand appear in AI responses? (appearances divided by 20) x 100</div>
                    </div>
                    <div style="padding:20px 0;border-bottom:1px solid #F3F4F6;">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                            <div style="font-size:0.95rem;font-weight:700;color:#111827;">Sentiment</div>
                            <div style="background:#EDE9FE;color:#5B21B6;border-radius:99px;padding:3px 14px;font-size:0.82rem;font-weight:700;">20%</div>
                        </div>
                        <div style="background:#F3F4F6;border-radius:4px;height:6px;width:100%;"><div style="background:#7C3AED;height:6px;border-radius:4px;width:20%;"></div></div>
                        <div style="font-size:0.82rem;color:#6B7280;margin-top:6px;">How positively was your brand mentioned? Average tone score across all appearances</div>
                    </div>
                    <div style="padding:20px 0;border-bottom:1px solid #F3F4F6;">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                            <div style="font-size:0.95rem;font-weight:700;color:#111827;">Prominence</div>
                            <div style="background:#EDE9FE;color:#5B21B6;border-radius:99px;padding:3px 14px;font-size:0.82rem;font-weight:700;">20%</div>
                        </div>
                        <div style="background:#F3F4F6;border-radius:4px;height:6px;width:100%;"><div style="background:#7C3AED;height:6px;border-radius:4px;width:20%;"></div></div>
                        <div style="font-size:0.82rem;color:#6B7280;margin-top:6px;">Was your brand named first or buried? First mention scores 100, fourth or later scores 25</div>
                    </div>
                    <div style="padding:20px 0;border-bottom:1px solid #F3F4F6;">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                            <div style="font-size:0.95rem;font-weight:700;color:#111827;">Citation Share</div>
                            <div style="background:#EDE9FE;color:#5B21B6;border-radius:99px;padding:3px 14px;font-size:0.82rem;font-weight:700;">15%</div>
                        </div>
                        <div style="background:#F3F4F6;border-radius:4px;height:6px;width:100%;"><div style="background:#7C3AED;height:6px;border-radius:4px;width:15%;"></div></div>
                        <div style="font-size:0.82rem;color:#6B7280;margin-top:6px;">Your brand mentions as a percentage of all brand mentions across all 20 responses</div>
                    </div>
                    <div style="padding:20px 0;">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                            <div style="font-size:0.95rem;font-weight:700;color:#111827;">Share of Voice</div>
                            <div style="background:#EDE9FE;color:#5B21B6;border-radius:99px;padding:3px 14px;font-size:0.82rem;font-weight:700;">15%</div>
                        </div>
                        <div style="background:#F3F4F6;border-radius:4px;height:6px;width:100%;"><div style="background:#7C3AED;height:6px;border-radius:4px;width:15%;"></div></div>
                        <div style="font-size:0.82rem;color:#6B7280;margin-top:6px;">Independent cross-validation of Citation Share. Must be within 2 points of Citation result</div>
                    </div>
                </div>
                <div style="background:#F5F3FF;border-radius:10px;padding:14px 18px;margin-top:16px;">
                    <div style="font-size:0.78rem;font-weight:700;color:#5B21B6;margin-bottom:4px;">GEO Score Formula</div>
                    <div style="font-size:0.82rem;color:#374151;">GEO = (Vis x 0.30) + (Sen x 0.20) + (Pro x 0.20) + (Cit x 0.15) + (SoV x 0.15)</div>
                </div>
            </div>
        </div>
    </div>""",unsafe_allow_html=True)
    ...
    # SCORE SCALE
    st.markdown("""
    <div style="background:#F9F9FC;padding:64px 120px;">
        <div style="text-align:center;margin-bottom:48px;">
            <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">Score Ranges</div>
            <h2 style="font-size:1.8rem;font-weight:800;color:#111827;margin:0;">What Does Your Score Mean?</h2>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:16px;">
            <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:28px 24px;">
                <div style="font-size:2rem;font-weight:900;color:#10B981;margin-bottom:8px;">80-100</div>
                <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;">Excellent</div>
                <div style="width:100%;height:4px;background:#D1FAE5;border-radius:4px;margin-bottom:12px;"></div>
                <div style="font-size:0.82rem;color:#6B7280;line-height:1.6;">Your brand is well optimized for AI citation. AI models consistently recommend you across key queries.</div>
            </div>
            <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:28px 24px;">
                <div style="font-size:2rem;font-weight:900;color:#3B82F6;margin-bottom:8px;">70-79</div>
                <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;">Good</div>
                <div style="width:100%;height:4px;background:#DBEAFE;border-radius:4px;margin-bottom:12px;"></div>
                <div style="font-size:0.82rem;color:#6B7280;line-height:1.6;">Strong AI presence with minor improvements recommended. You are visible but not always first.</div>
            </div>
            <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:28px 24px;">
                <div style="font-size:2rem;font-weight:900;color:#F59E0B;margin-bottom:8px;">45-69</div>
                <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;">Needs Work</div>
                <div style="width:100%;height:4px;background:#FEF3C7;border-radius:4px;margin-bottom:12px;"></div>
                <div style="font-size:0.82rem;color:#6B7280;line-height:1.6;">Several issues to address. Competitors are appearing more frequently and favorably than your brand.</div>
            </div>
            <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:28px 24px;">
                <div style="font-size:2rem;font-weight:900;color:#EF4444;margin-bottom:8px;">0-44</div>
                <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;">Poor</div>
                <div style="width:100%;height:4px;background:#FEE2E2;border-radius:4px;margin-bottom:12px;"></div>
                <div style="font-size:0.82rem;color:#6B7280;line-height:1.6;">Major optimization needed. Your brand is largely invisible to AI models across industry queries.</div>
            </div>
        </div>
    </div>""",unsafe_allow_html=True)

    # GEO IS CHANGING THE WORLD
    st.markdown("""
    <div style="background:white;padding:80px 120px;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center;">
            <div>
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">The Shift</div>
                <h2 style="font-size:2rem;font-weight:800;color:#111827;margin:0 0 20px 0;line-height:1.25;">GEO is No Longer Optional</h2>
                <p style="font-size:0.95rem;color:#6B7280;line-height:1.8;margin-bottom:20px;">While search spend continues to rise, its impact is fading as AI agents increasingly shape the decisions search used to influence.</p>
                <p style="font-size:0.95rem;color:#6B7280;line-height:1.8;">The brands that win the next decade will not just be the ones with the best products. They will be the ones AI recommends. Percepta is built to get you there.</p>
            </div>
            <div style="display:flex;flex-direction:column;gap:20px;">
                <div style="display:flex;align-items:flex-start;gap:20px;">
                    <div style="font-size:1.8rem;font-weight:900;color:#7C3AED;min-width:64px;">25%</div>
                    <div><div style="font-size:0.88rem;font-weight:600;color:#111827;margin-bottom:4px;">Drop in Traditional Search by 2026</div><div style="font-size:0.82rem;color:#6B7280;line-height:1.5;">Gartner forecasts traditional search engine traffic will drop as users shift to AI answer engines</div></div>
                </div>
                <div style="height:1px;background:#F3F4F6;"></div>
                <div style="display:flex;align-items:flex-start;gap:20px;">
                    <div style="font-size:1.8rem;font-weight:900;color:#7C3AED;min-width:64px;">&gt;59%</div>
                    <div><div style="font-size:0.88rem;font-weight:600;color:#111827;margin-bottom:4px;">Zero-Click Searches Today</div><div style="font-size:0.82rem;color:#6B7280;line-height:1.5;">Of Google searches now result in zero clicks. AI summaries are answering before users visit sites</div></div>
                </div>
                <div style="height:1px;background:#F3F4F6;"></div>
                <div style="display:flex;align-items:flex-start;gap:20px;">
                    <div style="font-size:1.8rem;font-weight:900;color:#7C3AED;min-width:64px;">&gt;18B</div>
                    <div><div style="font-size:0.88rem;font-weight:600;color:#111827;margin-bottom:4px;">Weekly AI Queries</div><div style="font-size:0.82rem;color:#6B7280;line-height:1.5;">ChatGPT processes 18B+ queries weekly from 700M+ users, all discovering brands through AI</div></div>
                </div>
            </div>
        </div>
    </div>""",unsafe_allow_html=True)
    ...
    # VALIDATED IMPACT
    st.markdown("""
    <div style="background:#7C3AED;padding:80px 120px;">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center;">
            <div>
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:rgba(255,255,255,0.6);text-transform:uppercase;margin-bottom:12px;">Proven Results</div>
                <h2 style="font-size:2rem;font-weight:800;color:white;margin:0 0 16px 0;line-height:1.25;">Validated Impact Across 10+ Client Engagements</h2>
                <p style="font-size:0.95rem;color:rgba(255,255,255,0.8);line-height:1.8;">Across retail, travel, financial services, and hospitality, Percepta has consistently delivered measurable improvements in AI brand visibility.</p>
            </div>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
                <div style="border:1px solid rgba(255,255,255,0.2);border-radius:12px;padding:24px;">
                    ...
                    <div style="font-size:0.82rem;font-weight:600;color:rgba(255,255,255,0.8);margin-top:6px;">Successful Clients</div>
                    <div style="font-size:0.76rem;color:rgba(255,255,255,0.55);margin-top:3px;">Across retail, travel, hospitality</div>
                </div>
                <div style="border:1px solid rgba(255,255,255,0.2);border-radius:12px;padding:24px;">
                    <div style="font-size:2.4rem;font-weight:900;color:white;">4X</div>
                    <div style="font-size:0.82rem;font-weight:600;color:rgba(255,255,255,0.8);margin-top:6px;">Higher Conversion</div>
                    <div style="font-size:0.76rem;color:rgba(255,255,255,0.55);margin-top:3px;">From ChatGPT vs traditional search</div>
                </div>
                <div style="border:1px solid rgba(255,255,255,0.2);border-radius:12px;padding:24px;">
                    <div style="font-size:2.4rem;font-weight:900;color:white;">15%</div>
                    <div style="font-size:0.82rem;font-weight:600;color:rgba(255,255,255,0.8);margin-top:6px;">Citation Growth</div>
                    <div style="font-size:0.76rem;color:rgba(255,255,255,0.55);margin-top:3px;">Improved brand authority in AI</div>
                </div>
                <div style="border:1px solid rgba(255,255,255,0.2);border-radius:12px;padding:24px;">
                    <div style="font-size:2.4rem;font-weight:900;color:white;">68%</div>
                    <div style="font-size:0.82rem;font-weight:600;color:rgba(255,255,255,0.8);margin-top:6px;">Longer Sessions</div>
                    <div style="font-size:0.76rem;color:rgba(255,255,255,0.55);margin-top:3px;">Through AI-optimized content</div>
                </div>
            </div>
        </div>
    </div>""",unsafe_allow_html=True)
    ...
    # CTA
    st.markdown("""<div style="background:#F9F9FC;padding:64px 120px;text-align:center;border-top:1px solid #E5E7EB;">
        <h2 style="font-size:1.8rem;font-weight:800;color:#111827;margin:0 0 12px 0;">Ready to see your GEO Score?</h2>
        <p style="font-size:0.95rem;color:#6B7280;margin:0 0 32px 0;">Enter your brand URL and get a complete AI visibility analysis in minutes.</p>
    </div>""",unsafe_allow_html=True)
...
# ════════════════════════════════════════════════════════════
    ...
    st.markdown("""
    <div style="background:#7C3AED;padding:52px 80px;color:white;">
        <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:rgba(255,255,255,0.65);text-transform:uppercase;margin-bottom:12px;">GEO Intelligence Hub</div>
        <h1 style="font-size:2.6rem;font-weight:900;color:white;margin:0 0 12px 0;">Measure. Benchmark. Improve.</h1>
        <div style="font-size:1rem;color:rgba(255,255,255,0.85);">Enter your brand URL and receive your complete GEO Score report in real time.</div>
    </div>""",unsafe_allow_html=True)
    ...
    with tabs[0]:
        ...
        if not has_result:
            # URL INPUT SECTION
            st.markdown("""
            <div style="max-width:680px;margin:0 auto;text-align:center;padding:40px 0 24px 0;">
                <h3 style="font-size:1.4rem;font-weight:800;color:#111827;margin:0 0 10px 0;">Analyze Your Brand's GEO Score</h3>
                <p style="font-size:0.9rem;color:#6B7280;margin:0 0 28px 0;">Enter any brand URL below. Percepta will run 200 live AI queries and generate your complete GEO report.</p>
            </div>""",unsafe_allow_html=True)
            ...
            vis = result.get("context",0); cit = result.get("reliability",0)
            sent = result.get("exclusivity",0); prom = result.get("organization",0)
            ...
            with info_col:
                ...
                st.markdown(f'<div style="background:white;border-radius:14px;border:1px solid #E5E7EB;padding:24px 28px;"><div style="font-size:1.3rem;font-weight:800;color:#111827;margin-bottom:4px;">{brand}</div><a href="{brand_url_}" target="_blank" style="color:#7C3AED;font-size:0.82rem;">{brand_url_[:70]}{"..." if len(brand_url_)>70 else ""}</a><div style="margin-top:14px;"><span style="background:{badge_bg};color:{badge_color};padding:4px 14px;border-radius:50px;font-size:0.78rem;font-weight:700;">{label}</span></div><div style="margin-top:14px;padding-top:12px;border-top:1px solid #F3F4F6;font-size:0.82rem;color:#6B7280;line-height:1.6;">{score_txt}</div></div>',unsafe_allow_html=True)

            st.markdown("<br>",unsafe_allow_html=True)
            tooltip_defs = {"Visibility Score":"How many of 20 generic AI queries mentioned your brand. Formula: (brand appearances / 20) x 100.","Citation Score":"How authoritatively your brand was cited. Top recommendation = 65 to 85. Listed among options = 20 to 40.","Sentiment Score":"Tone of AI responses when your brand appeared. Praised = 75 to 100. Neutral = 40 to 65. Criticized = 0 to 35.","Avg. Rank":"Average position your brand appeared. #1 = mentioned first."}
            mc1,mc2,mc3,mc4 = st.columns(4)
            for col,grad,icon,val,lbl,sub in [(mc1,"linear-gradient(135deg,#3B82F6,#06B6D4)","",vis,"Visibility Score","AI response presence"),(mc2,"linear-gradient(135deg,#8B5CF6,#A855F7)","",cit,"Citation Score","Source authority"),(mc3,"linear-gradient(135deg,#10B981,#34D399)","",sent,"Sentiment Score","Brand perception"),(mc4,"linear-gradient(135deg,#F59E0B,#FBBF24)","",avg_rank,"Avg. Rank","AI mention position")]:
                tip = tooltip_defs.get(lbl,"")
                with col:
                    st.markdown(f'<div style="background:white;border-radius:12px;padding:20px 18px;border:1px solid #E5E7EB;"><div style="width:8px;height:8px;border-radius:50%;background:#7C3AED;margin-bottom:14px;"></div><div style="font-size:1.8rem;font-weight:800;color:#111827;line-height:1;">{val}</div><div style="font-size:0.84rem;font-weight:600;color:#374151;margin-top:5px;display:flex;align-items:center;gap:4px;">{lbl}<span class="metric-tooltip"><span class="tooltip-icon">?</span><span class="tooltip-text">{tip}</span></span></div><div style="font-size:0.76rem;color:#9CA3AF;margin-top:2px;">{sub}</div></div>',unsafe_allow_html=True)
    ...
    if has_result:
        ...
        with tabs[1]:
            ...
            st.markdown(f'<div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;"><div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:4px;">{brand_domain} vs Competitors — {top10_title}</div><div style="font-size:0.78rem;color:#9CA3AF;margin-bottom:16px;">Real-time GEO scores across all competitors. Highlighted row is you.</div><table style="width:100%;border-collapse:collapse;"><thead><tr style="border-bottom:1px solid #E5E7EB;"><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">#</th><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Brand</th><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">GEO</th><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Visibility</th><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Citation</th><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Sentiment</th><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Share of Voice</th><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Avg Rank</th></tr></thead><tbody>{t10_rows}</tbody></table></div>',unsafe_allow_html=True)
            st.markdown("</div>",unsafe_allow_html=True)
        ...
        with tabs[2]:
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-bottom:24px;">
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Visibility Score</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#7C3AED;">{vis}%</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">Appeared in {result.get("responses_with_brand",0)} of 20 queries</div>
                </div>
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Average Rank</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#7C3AED;">{avg_rank}</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">Position when mentioned in AI responses</div>
                </div>
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Query Appearances</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#7C3AED;">{result.get("responses_with_brand",0)}/20</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">Out of 20 generic industry queries</div>
                </div>
            </div>""",unsafe_allow_html=True)
        ...
        with tabs[3]:
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-bottom:24px;">
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Sentiment Score</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#10B981;">{sent}</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">{"Positive: AI speaks favorably" if sent>=70 else "Neutral: room to improve" if sent>=45 else "Needs attention"}</div>
                </div>
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Prominence Score</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#7C3AED;">{prom}</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">{"Named first: strong prominence" if prom>=70 else "Mid-list mentions" if prom>=45 else "Buried in responses"}</div>
                </div>
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Average Rank</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#3B82F6;">{avg_rank}</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">Average mention position in AI responses</div>
                </div>
            </div>""",unsafe_allow_html=True)
            strengths = result.get("strengths_list",[])[:3]
            s_html = "".join(f'<li style="padding:10px 0;font-size:0.84rem;color:#374151;display:flex;gap:12px;align-items:flex-start;border-bottom:1px solid #F0FDF4;"><span style="color:#10B981;font-weight:700;flex-shrink:0;margin-top:1px;">+</span><span>{s}</span></li>' for s in strengths)
        ...
        with tabs[4]:
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:24px;">
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Citation Score</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#7C3AED;">{cit}</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">How authoritatively your brand was cited</div>
                </div>
                <div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;">
                    <div style="font-size:0.72rem;font-weight:600;color:#9CA3AF;letter-spacing:.08em;text-transform:uppercase;margin-bottom:8px;">Share of Voice</div>
                    <div style="font-size:2.2rem;font-weight:800;color:#7C3AED;">{sov}</div>
                    <div style="font-size:0.8rem;color:#6B7280;margin-top:4px;">Your brand mentions as % of all mentions</div>
                </div>
            </div>""",unsafe_allow_html=True)
        ...
        with tabs[5]:
            ...
            sel_cat = st.selectbox("Filter by category",["All"]+categories, label_visibility="visible")
            ...
            for c,v in cat_summary.items():
                ...
                cat_html += f'<div style="background:white;border:1px solid #E5E7EB;border-radius:8px;padding:14px 18px;"><div style="font-size:0.82rem;font-weight:600;color:#111827;margin-bottom:4px;">{c}</div><div style="display:flex;align-items:center;gap:8px;"><div style="background:#F3F4F6;border-radius:4px;height:5px;flex:1;overflow:hidden;"><div style="background:#7C3AED;height:5px;border-radius:4px;width:{vis_pct}%;"></div></div><span style="font-size:0.78rem;font-weight:700;color:#7C3AED;min-width:32px;">{vis_pct}%</span></div><div style="font-size:0.72rem;color:#9CA3AF;margin-top:4px;">{v["mentioned"]} of {v["total"]} queries</div></div>'
            ...
            for idx, item in enumerate(filtered):
                ...
                rank_display = f"#{real_pos}" if real_pos>0 else "N/A"
            ...
            st.markdown(f'<div style="background:white;border-radius:12px;border:1px solid #E5E7EB;padding:24px;"><div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:4px;">Top 10 Prompts</div><div style="font-size:0.78rem;color:#9CA3AF;margin-bottom:16px;">Generic consumer questions. No brand name used. Rank = position brand was mentioned in AI response.</div><table style="width:100%;border-collapse:collapse;"><thead><tr style="border-bottom:2px solid #E5E7EB;background:#FAFAFA;"><th style="padding:8px 12px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">#</th><th style="padding:8px 14px;text-align:left;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Query</th><th style="padding:8px 16px;text-align:center;font-size:0.72rem;color:#9CA3AF;font-weight:600;">Rank</th></tr></thead><tbody>{q_rows}</tbody></table></div>',unsafe_allow_html=True)
            st.markdown("</div>",unsafe_allow_html=True)
        ...
        with tabs[7]:
            ...
            if st.session_state.ai_history:
                if st.button("Clear history",key="clr_ai2"): st.session_state.ai_history=[]; st.rerun()
            st.markdown("</div>",unsafe_allow_html=True)
...
# ════════════════════════════════════════════════════════════
    ...
    st.markdown("""
    <div style="background:#7C3AED;padding:80px 120px;color:white;">
        <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:rgba(255,255,255,0.65);text-transform:uppercase;margin-bottom:12px;">Accenture GEO Services</div>
        <h1 style="font-size:3rem;font-weight:900;color:white;margin:0 0 16px 0;letter-spacing:-1px;">We've Got You Covered</h1>
        <p style="font-size:1rem;color:rgba(255,255,255,0.85);max-width:560px;margin:0;line-height:1.8;">From GEO diagnostic to full optimization. Accenture's team handles everything, end to end.</p>
    </div>""",unsafe_allow_html=True)

    # WORKSTREAM INFINITY DIAGRAM SECTION
    st.markdown("""
    <div style="background:white;padding:80px 120px;">
        <div style="margin-bottom:16px;">
            <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">Our Approach</div>
            <h2 style="font-size:2rem;font-weight:800;color:#111827;margin:0 0 8px 0;">GEO is No Longer Optional</h2>
            <p style="font-size:0.9rem;color:#6B7280;max-width:640px;">While search spend continues to rise, its impact is fading as AI agents increasingly shape the decisions search used to influence.</p>
        </div>
        <div style="display:grid;grid-template-columns:1fr auto 1fr;gap:40px;align-items:center;margin:48px 0;">
            <div style="display:flex;flex-direction:column;gap:40px;">
                <div style="padding:24px 28px;border:1px solid #E5E7EB;border-radius:12px;">
                    <div style="font-size:0.72rem;font-weight:700;color:#7C3AED;letter-spacing:.08em;text-transform:uppercase;margin-bottom:6px;">Workstream 1</div>
                    <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;font-style:italic;">Agent Ranking Diagnostic (ARD)</div>
                    <p style="font-size:0.84rem;color:#6B7280;line-height:1.6;margin:0;">Conduct the initial evaluation to <strong>establish the baseline ranking performance</strong> of AI agents when comparing your brand to competitive offerings across several high-intent consumer scenarios.</p>
                </div>
                <div style="padding:24px 28px;border:1px solid #E5E7EB;border-radius:12px;">
                    <div style="font-size:0.72rem;font-weight:700;color:#7C3AED;letter-spacing:.08em;text-transform:uppercase;margin-bottom:6px;">Workstream 4</div>
                    <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;font-style:italic;">Impact Measurement (Re-Diagnostic)</div>
                    <p style="font-size:0.84rem;color:#6B7280;line-height:1.6;margin:0;">Following the optimization activities, the Agent Ranking Diagnostic will be performed again to <strong>re-measure performance</strong> and quantify improvements and establish ongoing program foundation.</p>
                </div>
            </div>
            <div style="display:flex;align-items:center;justify-content:center;padding:0 20px;">
                <svg width="180" height="120" viewBox="0 0 180 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M45 60 C45 38 60 20 80 20 C100 20 110 38 110 60 C110 82 120 100 140 100 C160 100 170 82 170 60 C170 38 160 20 140 20 C120 20 110 38 110 60 C110 82 100 100 80 100 C60 100 45 82 45 60Z" stroke="#7C3AED" stroke-width="8" fill="none"/>
                    <polygon points="108,52 116,60 108,68" fill="#7C3AED"/>
                    <polygon points="112,52 104,60 112,68" fill="#5B21B6"/>
                </svg>
            </div>
            <div style="display:flex;flex-direction:column;gap:40px;">
                <div style="padding:24px 28px;border:1px solid #E5E7EB;border-radius:12px;">
                    <div style="font-size:0.72rem;font-weight:700;color:#7C3AED;letter-spacing:.08em;text-transform:uppercase;margin-bottom:6px;">Workstream 3</div>
                    <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;font-style:italic;">Distribution and Technical Influence (DTI)</div>
                    <p style="font-size:0.84rem;color:#6B7280;line-height:1.6;margin:0;">Pinpoint and <strong>propose specific technical and distribution improvements</strong> to maximize the chance that LLMs ingest and utilize your verified content.</p>
                </div>
                <div style="padding:24px 28px;border:1px solid #E5E7EB;border-radius:12px;">
                    <div style="font-size:0.72rem;font-weight:700;color:#7C3AED;letter-spacing:.08em;text-transform:uppercase;margin-bottom:6px;">Workstream 2</div>
                    <div style="font-size:1rem;font-weight:700;color:#111827;margin-bottom:8px;font-style:italic;">Agent Optimization Plan (AOP)</div>
                    <p style="font-size:0.84rem;color:#6B7280;line-height:1.6;margin:0;">Based on the diagnostic findings, <strong>design and deploy a specific optimization strategy</strong> aimed at elevating agent recognition and positioning of your brand's offerings.</p>
                </div>
            </div>
        </div>
        <div style="display:flex;gap:48px;padding-top:32px;border-top:1px solid #F3F4F6;">
            <div style="text-align:center;"><div style="font-size:3.2rem;font-weight:900;color:#111827;line-height:1;">6</div><div style="font-size:0.9rem;font-weight:600;color:#111827;">Week Engagement</div><div style="font-size:0.8rem;color:#6B7280;margin-top:3px;">Phase 1</div></div>
            <div style="width:1px;background:#F3F4F6;"></div>
            <div style="text-align:center;"><div style="font-size:3.2rem;font-weight:900;color:#111827;line-height:1;">2</div><div style="font-size:0.9rem;font-weight:600;color:#111827;">AI Agents</div><div style="font-size:0.8rem;color:#6B7280;margin-top:3px;">ChatGPT and Gemini</div></div>
            <div style="width:1px;background:#F3F4F6;"></div>
            <div style="text-align:center;"><div style="font-size:3.2rem;font-weight:900;color:#111827;line-height:1;">4</div><div style="font-size:0.9rem;font-weight:600;color:#111827;">Workstreams</div><div style="font-size:0.8rem;color:#6B7280;margin-top:3px;">End to end coverage</div></div>
        </div>
    </div>""",unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="background:#F9F9FC;padding:64px 120px;">
        <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">Deliverables</div>
        <h2 style="font-size:1.8rem;font-weight:800;color:#111827;margin:0 0 40px 0;">Activities and What We Deliver</h2>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:3px;margin-bottom:16px;">
            <div style="background:#1E1B5E;padding:20px 18px;border-radius:8px 0 0 0;clip-path:polygon(0 0,93% 0,100% 50%,93% 100%,0 100%);"><div style="font-size:0.7rem;font-weight:600;color:rgba(255,255,255,0.65);margin-bottom:6px;text-transform:uppercase;letter-spacing:.08em;">Workstream 01</div><div style="font-size:0.9rem;font-weight:700;color:white;line-height:1.3;">Agent Ranking Diagnostic</div></div>
            <div style="background:#2D2A70;padding:20px 18px 20px 26px;clip-path:polygon(0 0,93% 0,100% 50%,93% 100%,0 100%,7% 50%);"><div style="font-size:0.7rem;font-weight:600;color:rgba(255,255,255,0.65);margin-bottom:6px;text-transform:uppercase;letter-spacing:.08em;">Workstream 02</div><div style="font-size:0.9rem;font-weight:700;color:white;line-height:1.3;">Agent Optimization Plan</div></div>
            <div style="background:#3D3A8A;padding:20px 18px 20px 26px;clip-path:polygon(0 0,93% 0,100% 50%,93% 100%,0 100%,7% 50%);"><div style="font-size:0.7rem;font-weight:600;color:rgba(255,255,255,0.65);margin-bottom:6px;text-transform:uppercase;letter-spacing:.08em;">Workstream 03</div><div style="font-size:0.9rem;font-weight:700;color:white;line-height:1.3;">Distribution and Technical Influence</div></div>
            <div style="background:#5B21B6;padding:20px 18px 20px 26px;border-radius:0 8px 0 0;clip-path:polygon(0 0,100% 0,100% 100%,0 100%,7% 50%);"><div style="font-size:0.7rem;font-weight:600;color:rgba(255,255,255,0.65);margin-bottom:6px;text-transform:uppercase;letter-spacing:.08em;">Workstream 04</div><div style="font-size:0.9rem;font-weight:700;color:white;line-height:1.3;">Impact Measurement</div></div>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:12px;margin-bottom:12px;">
            <div style="background:white;border:1px solid #E5E7EB;border-radius:0 0 8px 8px;padding:18px;"><div style="font-size:0.82rem;font-weight:700;color:#111827;border-bottom:1px solid #F3F4F6;padding-bottom:8px;margin-bottom:12px;">Activities</div><ul style="list-style:disc;padding-left:16px;margin:0;font-size:0.78rem;color:#374151;line-height:1.7;"><li>Develop representative prompts across key personas</li><li>Execute multi-run stability testing</li><li>Extract agent-generated rankings</li><li>Perform power distribution modeling</li><li>Build competitor adjacency maps</li></ul></div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:12px;">
            <div style="background:#F9F9FC;border:1px solid #E5E7EB;border-radius:8px;padding:18px;"><div style="font-size:0.82rem;font-weight:700;color:#111827;border-bottom:1px solid #E5E7EB;padding-bottom:8px;margin-bottom:12px;">Deliverables</div><ul style="list-style:disc;padding-left:16px;margin:0;font-size:0.78rem;color:#374151;line-height:1.7;"><li>AXO Baseline Report</li><li>Brand and Product Ranking Index</li><li>Power Curve Analysis</li><li>Attribute Influence Map</li><li>AXO Baseline Score v1.0</li></ul></div>
    ...
    # PILOT OPTIONS — FULL WIDTH SPREAD OUT
    st.markdown("""
    <div style="background:white;padding:80px 120px;">
        <div style="text-align:center;margin-bottom:56px;">
            <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">Explore Offers</div>
            <h2 style="font-size:2rem;font-weight:800;color:#111827;margin:0 0 12px 0;">Choose Your Pilot Program</h2>
            <p style="font-size:0.95rem;color:#6B7280;max-width:480px;margin:0 auto;">Start with what fits your timeline. Scale as you see results.</p>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:32px;">
            <div style="border:1px solid #E5E7EB;border-radius:16px;padding:40px 36px;position:relative;">
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#9CA3AF;text-transform:uppercase;margin-bottom:12px;">Option 1</div>
                <div style="font-size:3rem;font-weight:900;color:#111827;line-height:1;margin-bottom:4px;">6</div>
                <div style="font-size:1rem;font-weight:600;color:#111827;margin-bottom:24px;">Week Engagement</div>
                <div style="height:1px;background:#F3F4F6;margin-bottom:24px;"></div>
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:12px;">
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Agent Ranking Diagnostic (ARD)</li>
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Agent Optimization Plan (AOP)</li>
                </ul>
            </div>
            <div style="border:2px solid #7C3AED;border-radius:16px;padding:40px 36px;position:relative;background:#FAFBFF;">
                <div style="position:absolute;top:-14px;left:50%;transform:translateX(-50%);background:#7C3AED;color:white;border-radius:50px;padding:4px 18px;font-size:0.75rem;font-weight:700;white-space:nowrap;">Recommended</div>
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#7C3AED;text-transform:uppercase;margin-bottom:12px;">Option 2</div>
                <div style="font-size:3rem;font-weight:900;color:#111827;line-height:1;margin-bottom:4px;">7</div>
                <div style="font-size:1rem;font-weight:600;color:#111827;margin-bottom:24px;">Week Engagement</div>
                <div style="height:1px;background:#E5E7EB;margin-bottom:24px;"></div>
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:12px;">
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Agent Ranking Diagnostic (ARD)</li>
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Agent Optimization Plan (AOP)</li>
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Impact Measurement (Re-Diagnostic)</li>
                </ul>
            </div>
            <div style="border:1px solid #E5E7EB;border-radius:16px;padding:40px 36px;position:relative;">
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:.12em;color:#9CA3AF;text-transform:uppercase;margin-bottom:12px;">Option 3</div>
                <div style="font-size:3rem;font-weight:900;color:#111827;line-height:1;margin-bottom:4px;">7</div>
                <div style="font-size:1rem;font-weight:600;color:#111827;margin-bottom:24px;">Week Engagement</div>
                <div style="height:1px;background:#F3F4F6;margin-bottom:24px;"></div>
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:12px;">
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Agent Ranking Diagnostic (ARD)</li>
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Agent Optimization Plan (AOP)</li>
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Distribution and Technical Influence (DTI)</li>
                    <li style="display:flex;align-items:flex-start;gap:10px;font-size:0.88rem;color:#374151;"><span style="color:#7C3AED;font-weight:700;margin-top:1px;">+</span>Impact Measurement (Re-Diagnostic)</li>
                </ul>
            </div>
        </div>
