...
if nav=="Overview":
    ...
    # WHY THIS MATTERS — GEO Score intro + chain diagram (pure HTML, one section)
    st.markdown("""
    <div style="background:#F9F9FC;padding:96px 40px;border-top:1px solid #E5E7EB;">
        <div style="max-width:960px;margin:0 auto;">
            <div style="text-align:center;margin-bottom:64px;">
                ...
                <p style="font-size:1rem;color:#6B7280;max-width:620px;margin:0 auto;line-height:1.8;">A single 0 to 100 number that tells you exactly how visible and favorably your brand appears across AI-generated responses. Every point you gain cascades through your entire growth funnel.</p>
            </div>
            <div style="display:grid;grid-template-columns:1fr 28px 1fr 28px 1fr 28px 1fr 28px 1fr 28px 1fr;gap:0;align-items:center;">
                <div style="text-align:center;padding:28px 14px;background:#7C3AED;border-radius:14px;">
                    <div style="font-size:0.88rem;font-weight:800;color:white;margin-bottom:10px;">GEO Score</div>
                    <div style="font-size:0.74rem;color:rgba(255,255,255,0.85);line-height:1.6;">Measures how strongly your brand appears in AI responses</div>
                </div>
                <div style="text-align:center;font-size:1.3rem;color:#7C3AED;font-weight:700;">→</div>
                <div style="text-align:center;padding:28px 14px;background:#EDE9FE;border-radius:14px;">
                    <div style="font-size:0.88rem;font-weight:800;color:#7C3AED;margin-bottom:10px;">Ranking</div>
                    <div style="font-size:0.74rem;color:#6B7280;line-height:1.6;">Higher scores help your brand appear more competitively vs others</div>
                </div>
                <div style="text-align:center;font-size:1.3rem;color:#7C3AED;font-weight:700;">→</div>
                <div style="text-align:center;padding:28px 14px;background:#EDE9FE;border-radius:14px;">
                    <div style="font-size:0.88rem;font-weight:800;color:#7C3AED;margin-bottom:10px;">Visibility</div>
                    <div style="font-size:0.74rem;color:#6B7280;line-height:1.6;">More visibility — users see your brand in AI answers more often</div>
                </div>
                <div style="text-align:center;font-size:1.3rem;color:#7C3AED;font-weight:700;">→</div>
                <div style="text-align:center;padding:28px 14px;background:#EDE9FE;border-radius:14px;">
                    <div style="font-size:0.88rem;font-weight:800;color:#7C3AED;margin-bottom:10px;">Traffic</div>
                    <div style="font-size:0.74rem;color:#6B7280;line-height:1.6;">More visibility leads to more clicks and site visits</div>
                </div>
                <div style="text-align:center;font-size:1.3rem;color:#7C3AED;font-weight:700;">→</div>
                <div style="text-align:center;padding:28px 14px;background:#EDE9FE;border-radius:14px;">
                    <div style="font-size:0.88rem;font-weight:800;color:#7C3AED;margin-bottom:10px;">Conversion</div>
                    <div style="font-size:0.74rem;color:#6B7280;line-height:1.6;">More qualified traffic creates more calls and actions</div>
                </div>
                <div style="text-align:center;font-size:1.3rem;color:#7C3AED;font-weight:700;">→</div>
                <div style="text-align:center;padding:28px 14px;background:#7C3AED;border-radius:14px;">
                    <div style="font-size:0.88rem;font-weight:800;color:white;margin-bottom:10px;">Revenue</div>
                    <div style="font-size:0.74rem;color:rgba(255,255,255,0.85);line-height:1.6;">Better conversions translate into measurable business growth</div>
                </div>
            </div>
        </div>
    </div>""", unsafe_allow_html=True)
    ...
    <div style="background:#F9F9FC;padding:96px 40px;border-top:1px solid #E5E7EB;text-align:center;">
        <div style="max-width:600px;margin:0 auto;">
            ...
            <div style="background:linear-gradient(135deg,#7C3AED 0%,#5B21B6 100%);border-radius:18px;padding:36px 40px;text-align:center;box-shadow:0 12px 48px rgba(124,58,237,0.28);max-width:420px;margin:0 auto;">
                <div style="font-size:1.35rem;font-weight:900;color:white;margin-bottom:8px;">Launch GEO Hub</div>
                <div style="font-size:0.9rem;color:rgba(255,255,255,0.78);margin-bottom:24px;">Analyse your brand's AI visibility now</div>
            </div>
        </div>
    </div>""", unsafe_allow_html=True)
